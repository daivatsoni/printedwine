<?php
	...
	$update_Qry = "UPDATE user_templates set template_name = '".$_POST['filename']."',canvas_thumbnail = 'templates/". $templateid . ".png', canvas_json = 'templates/". $templateid . ".ype', modified_date = now() WHERE template_id = " . $templateid;
