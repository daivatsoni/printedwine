				...
				<div class="header_tab list-group list-group-horizontal">
					<ul>
						<li class="list-group-item"><a href="<?php echo get_site_url(); ?>/member-dashboard/edit-account/">My Profile</a></li>
                                                <li class="list-group-item"><a href="<?php echo get_site_url(); ?>/member-dashboard/artist_profile/">Artist Profile</a></li>
						<li class="list-group-item"><a href="<?php echo get_site_url(); ?>/member-dashboard/my_gallery/">My Gallery</a></li>
