    ...
    function widget($args, $instance) {
        ...
        <div class="widget_inner">
            <?php if ($show_icons) {
                ...
                <ul class="test social_link social_style_<?php echo get_theme_options_attribute('social_icons', 'style') ?>">
                <?php foreach ($socials as $s) {
                    if (empty($s['url'])) continue; ?>
                    <li><a class="social_icons" href="<?php echo $s['url']; ?>" target="_blank"><img src="<?php echo $s['icon']; ?>" alt="" /></a></li>
                <?php } // endforeach ?>
            ...
            <?php if ($show_logo) {
                ...
                <?php } else if (($logo_text = get_theme_option('logo_text')) != '') {
