...
define( 'NOTIFIER_THEME_NAME', 'Wine' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'wine' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://themerex.net/!updates/updates_wine.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
