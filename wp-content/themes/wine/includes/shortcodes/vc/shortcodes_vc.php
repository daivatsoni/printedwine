...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"description" => __("Animation switch", "themerex"),
			"class" => "",
			"value" => array("On" => "yes" ),
			"type" => "checkbox"
		),
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			"param_name" => "ajax",
			"heading" => __("Single page Ajax loading", "themerex"),
			"description" => __("Enables page loading with Ajax (works with style=cube)", "themerex"),
			"group" => __('Query', 'themerex'),
			"class" => "",
			"value" => array(__('On', 'themerex') => 'yes'),
			"type" => "checkbox"
		),
		array(
			"param_name" => "indent",
...
vc_map( array(
	"base" => "trx_cube",
	"name" => __("Cube", "themerex"),
	"description" => __("Cube content", "themerex"),
	"category" => __('Content', 'js_composer'),
	'icon' => 'icon_trx_cube',
	"class" => "trx_sc_collection trx_sc_cube",
	"content_element" => true,
	"is_container" => true,
	"show_settings_on_create" => true,
	"as_parent" => array('only' => 'trx_cube_item'),
	"params" => array(
		array(
			"param_name" => "type",
...
vc_map( array(
	"base" => "trx_cube_item",
	"name" => __("Cube item", "themerex"),
	"description" => __("Single cube item", "themerex"),
	"show_settings_on_create" => true,
	"content_element" => true,
	"is_container" => true,
	"as_child" => array('only' => 'trx_cube'),
	"as_parent" => array('except' => 'trx_cube'),
	"params" => array(
		array(
			"param_name" => "title",
			"heading" => __("Title", "themerex"),
		...
		array(
			"param_name" => "desc",
			"heading" => __("Cube item description", "themerex"),
			"description" => "",
			"class" => "",
			"value" => "",
			"type" => "textfield"
		...
		array(
			"param_name" => "size",
			"heading" => __("Cube item size", "themerex"),
			"description" => __("By default post display will look like a cube.  Rectangle will be 2x bigger", "themerex"),
			"class" => "",
			"admin_label" => true,
			"value" => array(
				__('1 x 1', 'themerex') => '1_1',
				__('2 x 1', 'themerex') => '2_1',
			),
			"type" => "dropdown"
		),
		array(
			...
			"description" => "Select or upload image or write URL from other site",
			"class" => "",
			"value" => "",
			"type" => "attach_image"
		),
		array(
			"param_name" => "bg",
			"heading" => __("Background item color", "themerex"),
			"description" => "",
			"class" => "",
			"value" => "",
			"type" => "colorpicker"
		...
		array(
			...
			"description" => __("URL for link on item click", "themerex"),
			"class" => "",
			"value" => "",
			"type" => "textfield"
		),
...
class WPBakeryShortCode_Trx_Cube extends THEMEREX_VC_ShortCodeContainer {}
class WPBakeryShortCode_Trx_Cube_Item extends THEMEREX_VC_ShortCodeSingle {}
...
vc_map( array(
	...
	"description" => __("Events calendar", "themerex"),
	"category" => __('Content', 'js_composer'),
    'icon' => 'trx_events',
	"class" => "trx_sc_single trx_sc_br",
	"content_element" => true,
	...
	"params" => array(
		array(
			"param_name" => "count",
			"heading" => __("Counter", "themerex"),
			"description" => __("Number of output events", "themerex"),
			"class" => "",
			"value" => "",
			"type" => "textfield"
		),
		array(
			"param_name" => "cat",
			"heading" => __("ID category", "themerex"),
			"description" => __("ID category events", "themerex"),
			"class" => "",
			"value" => "",
			"type" => "textfield"
		),
...
//class WPBakeryShortCode_Trx_Contact_Form extends WPBakeryShortCodesSingle {}
...
vc_map( array(
	...
	"description" => __("Select elements", "themerex"),
	"category" => __('Content', 'js_composer'),
    'icon' => 'icon_trx_contact_info',
	"class" => "trx_sc_container trx_contact_info",
	"content_element" => true,
	"is_container" => false,
	"show_settings_on_create" => true,
	"params" => array(
		array(
			...
			"admin_label" => true,
			"class" => "",
			"value" => array_flip($THEMEREX_shortcodes_contact_info),
			"type" => "checkbox"
		),
		THEMEREX_VC_margin_top(),
		THEMEREX_VC_margin_right(),
...
//class WPBakeryShortCode_Trx_Contact_Info extends WPBakeryShortCodesSingle {}
...
//class WPBakeryShortCode_Trx_Search extends WPBakeryShortCodesContainer {}
...
vc_map( array(
	...
	"class" => "trx_sc_container trx_sc_sidebar",
	"content_element" => true,
	"is_container" => false,
	"show_settings_on_create" => true,
	"params" => array(
		...
		array(
			"param_name" => "columns",
			"heading" => __("Sidebar columns", "themerex"),
			"description" => __("Set number of columns", "themerex"),
			"admin_label" => true,
			"class" => "",
			"value" => array(
				__("Columns 1", "themerex") => "1",
				__("Columns 2", "themerex") => "2",
				__("Columns 3", "themerex") => "3",
				__("Columns 4", "themerex") => "4",
				__("Columns 5", "themerex") => "5",
				__("Columns 6", "themerex") => "6"
			),
			"type" => "dropdown"
		),
		THEMEREX_VC_margin_top(),
...
//class WPBakeryShortCode_Trx_Sidebar extends WPBakeryShortCodesSingle {}
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"class" => "",
			"value" => array(__('info', 'themerex') => 'yes'),
			"type" => "checkbox"
		),
		THEMEREX_VC_margin_top(),
		THEMEREX_VC_margin_right(),
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			"param_name" => "sep",
			"heading" => __("Icon separator", "themerex"),
			"class" => "",
			"value" => array(__('Yes', 'themerex') => 'yes'),
			"type" => "checkbox"
		),
		THEMEREX_VC_width(),
		THEMEREX_VC_height(),
