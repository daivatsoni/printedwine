<div>
    ...
    <div class="fpd-element-toolbar fpd-visibility">
        ...
        <div class="fpd-text-tools fpd-row fpd-clearfix">
            ...
            <div class="fpd-tool-text-size fpd-tooltip" data-defaulttext="Font Size" title="toolbar.font_size">
                ...
                <input type="number" class="fpd-number" value="12" step="1" min="1" max="100" data-control="fontSize" />
            </div>
    ...
    <div class="fpd-stage-off-canvas">

        <div class="fpd-manage-layers-panel" data-context="manage-layers">
        ...
        <div class="fpd-saved-designs-panel"  data-context="saved-designs">
        ...
        <div class="fpd-upload-zone-adds-panel"  data-context="upload-zone-adds">
            <div class="fpd-off-canvas-nav fpd-primary-bg-color">
            ...
            <div class="fpd-off-canvas-content">

            </div>
        </div>

        <div class="fpd-close-stage-off-canvas">
