...
require_once(URE_PLUGIN_DIR .'includes/pro/class-utils.php');
require_once(URE_PLUGIN_DIR .'includes/pro/class-mutex.php');
require_once(URE_PLUGIN_DIR .'includes/class-assign-role.php');
require_once(URE_PLUGIN_DIR .'includes/pro/class-assign-role-pro.php');
